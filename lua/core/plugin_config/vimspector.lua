...
local function set_keybindings()
  ...
  vim.keymap.set('n', '<leader>dG', "<CMD>lua require('core.plugin_config.vimspector').generate_debug_profile()<CR>")
  ...
  vim.keymap.set('n', '<leader>di', "<CMD>call vimspector#Into()<CR>")
